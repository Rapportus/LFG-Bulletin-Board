...
GBB.dungeonTagsLoc={
	enGB = langSplit({
		...
		["STORMWIND"] = "sw strom storm stromwind stormwind",
		...
		["FEATHERMOON"] = "feralas feather feathermoon",
		...
		["RFK"] = 	"rfk kraul" ,
		["SM2"] =	"notsm",
		["SMANY"] = "tirisfal glades sm scarlet monastery mona",
		["SMG"] = 	"smgy smg gy graveyard" ,
		["SML"] = 	"smlib sml lib library" ,
		["SMA"] = 	"smarm sma arm armory herod armoury" ,
